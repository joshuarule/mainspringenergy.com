...
var Popover = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  var allowedAutoPlacements = props.allowedAutoPlacements,
      ...
      restProps = _objectWithoutProperties(props, ["allowedAutoPlacements", "arrowClassName", "boundaryElement", "cardClassName", "children", "className", "content", "disabled", "fallbackPlacements", "layer", "open", "placement", "portal", "style", "targetElement"]);
  ...
  if (open) {
    ...
    if (layer) {
      popperNode = /*#__PURE__*/_react.default.createElement(_layer.Layer, {
        className: _popover.default.layer
      }, popperNode);
    }

    if (portal) {
      popperNode = /*#__PURE__*/_react.default.createElement(_portal.Portal, null, popperNode);
    }
  }
